...
export function Hero() {
  ...
  return (
    <div ref={containerRef} className="relative min-h-screen overflow-hidden bg-gradient-to-br from-blue-50 via-sky-50 to-cyan-50">
    ...
    space-y-4 sm:space-y-6 w-full max-w-xl mx-auto text-center lg:mx-0 lg:text-left relative">
            ...
            >
              ...
              >
                <Sparkles className="w-3.5 h-3.5 sm:w-4 sm:h-4" style={{ color: '#2EA7E0' }} />
              </motion.div>
              <span className="relative z-10 text-xs sm:text-sm" style={{ color: '#1e293b' }}>Trusted by 10,000+ retailers</span>
            </motion.div>
            ...
            >
              <span className="block uppercase tracking-normal relative" style={{ color: '#3DB2FF' }}>
                <motion.span
              ...
              <span className="block text-black uppercase tracking-normal relative text-center mx-auto"
                style={{ color: '#000000' }}
              >
                <motion.span
                  className="inline-block"
  ...
  lg:mx-0"
            >
              Empowering kirana stores, supermarkets, multi-counter retail outlets with one integrated Android POS system
            </motion.p>
            ...
            >
              ...
              <AnimatedButton variant="secondary" onClick={() => setIsBrochureOpen(true)}>
                Download Brochure
            ...
            >
              ...
              >
                ...
                <div className="text-xs sm:text-sm text-slate-600">Retailers</div>
              </motion.div>
              ...
              >
                ...
                <div className="text-xs sm:text-sm text-slate-600">Smart Minds</div>
              </motion.div>
            </motion.div>
          </div>
